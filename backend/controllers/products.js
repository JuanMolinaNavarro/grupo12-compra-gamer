...
const updateProduct = (req, res) => {
    ...
    const query = "UPDATE productos SET nombre = ?, descripcion = ?, precio = ?, stock = ?, imagen_url = ? WHERE id_producto = ?"

    connection.query(query, [nombre, descripcion, precio, stock, imagen_url, id], (err, results) => {
        if (err) {
...
const createProduct = (req, res) => {
    ...
    const query = "INSERT INTO productos (nombre, descripcion, precio, stock, id_categoria, id_marca, imagen_url) VALUES (?,?,?,?,?,?,?)"

    connection.query(query, [nombre, descripcion, precio, stock, id_categoria, id_marca, imagen_url], (err, results) => {
        if (err) {
...
module.exports = { getAllProducts, getOneProduct, deleteProduct, updateProduct, createProduct, getProductosConCategoria }