...
const login = (req, res) => {
    ...
    connection.query(query, [email, contraseña], (err, results) => {
        ...
        // Usuario encontrado, devolver datos del usuario
...
const register = (req, res) => {
    ...
    connection.query(checkEmailQuery, [email], (err, results) => {
        ...
        const insertQuery = "INSERT INTO usuarios (nombre, apellido, email, contraseña, telefono) VALUES (?, ?, ?, ?, ?)"
        
        connection.query(insertQuery, [nombre, apellido, email, contraseña, telefono], (err, results) => {
            if (err) {
