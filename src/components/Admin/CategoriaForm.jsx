...
const CategoriaForm = ({ categoria, accion, onGuardar, onCancelar }) => {
  ...
  const titulo = accion === 'crear' ? 'Nueva Categoría' : 'Editar Categoría'
    ...
    <div className="form-container">
      ...
      <form onSubmit={manejarSubmit} className="categoria-form">
        ...
        <div className="form-acciones">
          ...
          >
            {accion === 'crear' ? 'Crear Categoría' : 'Guardar Cambios'}
          </button>
        </div>
      </form>
    </div>
